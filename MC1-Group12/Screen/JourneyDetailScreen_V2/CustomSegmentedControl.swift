...
struct SegmentedPicker: View {
    private static let ActiveSegmentColor: Color = Color.accentColor
    ...
    private static let TextFont: Font = .custom("", size: 17).weight(.medium)
    ...
    private var activeSegmentView: AnyView {
        ...
        return
            RoundedRectangle(cornerRadius: SegmentedPicker.SegmentCornerRadius)
                ...
                .frame(width: self.segmentSize.width, height: 40)
    ...
    var body: some View {
        ...
        .background(RoundedRectangle(cornerRadius: SegmentedPicker.SegmentCornerRadius).stroke(Color.darkGreen.opacity(0.5)))
